...
private:
    /**
       Changes the contents of arr_ to have all non-null vehicles strictly at the end of the array and all
       inserted vehicles at the beginning of the array. HINT: create a new array and repoint arr_; don't
       do this "in-place"
    */
    void arrange();
...
public:
    ...
    /**
       ...
       As an example, if we had a garage that already contains a Audi
       the default garage would have a Audi  object in both its first and second indexes.
